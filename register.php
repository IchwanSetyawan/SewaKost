<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $register = "INSERT INTO registrasi (Tanggal_Daftar,Lama_Menyewa,Tarif,Total_Tarif,Kode_KamarKost, ID_Penghuni)
...
<div class="container">
    <div class="row">
    <div class="header">
        <h2>Welcome to Home Stay 96B</h2>
    </div>
        ...
        <div class="form">
            <table>
                    <tr class="img">
                        <td rowspan="8">
                        <img src="./image/unsplash2.jpg" alt="img" width="450" height="400">
                        </td>
                    </tr>
                    <tr>
                        <td><b>Nama</b></td>
            ...
            <input type="submit" name="submit" value="REGISTRASI" class="btn-login">
